...
enum DeviceType { Pc, Arabia, Table }
...
class ModernBackground extends StatelessWidget {
  ...
  int _getCrossAxisCount(BuildContext context) {BuildContext context) {
              ...
              child: GestureDetector(
                ...
                child: AnimatedScale(
                  ...
                  child: AnimatedContainer(
                    ...
                    height: 100,
                    decoration: BoxDecoration(
                      // إذا كان القسم PC أو PlayStation أو Table ضع صورة الخلفية
                      image: widget.deviceType == DeviceType.Pc
                          ...
                          : widget.deviceType == DeviceType.Arabia
                              ...
                              : widget.deviceType == DeviceType.Table
                                  ...
                                  : null,
                      gradient: (widget.deviceType == DeviceType.Pc || widget.deviceType == DeviceType.Arabia || widget.deviceType == DeviceType.Table)
                          ? null
                          : (isBusy
                              ? LinearGradient(
                                  begin: Alignment.topLeft,
                      ...
                      boxShadow: [
                        BoxShadow(
                          ...
                          blurRadius: (widget.deviceType == DeviceType.Pc || widget.deviceType == DeviceType.Arabia || widget.deviceType == DeviceType.Table) ? 32 : (isBusy ? 22 : 14),
                          spreadRadius: (widget.deviceType == DeviceType.Pc || widget.deviceType == DeviceType.Arabia || widget.deviceType == DeviceType.Table) ? 4 : (isBusy ? 2 : 0),
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(28),
            child: (widget.deviceType == DeviceType.Pc || widget.deviceType == DeviceType.Arabia || widget.deviceType == DeviceType.Table)
              ? Stack(
                              children: [
